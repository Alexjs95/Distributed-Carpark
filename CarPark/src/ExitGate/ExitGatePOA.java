...
public abstract class ExitGatePOA extends org.omg.PortableServer.Servant
 implements ExitGate.ExitGateOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // ExitGate/ExitGate/_get_machine_name
       {
         String $result = null;
       ...
       case 1:  // ExitGate/ExitGate/register_gate
       {
       ...
       case 2:  // ExitGate/ExitGate/turn_on
       {
         this.turn_on ();
         out = $rh.createReply();
         break;
       ...
       case 3:  // ExitGate/ExitGate/turn_off
       {
         this.turn_off ();
         out = $rh.createReply();
         break;
       ...
       case 4:  // ExitGate/ExitGate/reset
       {
         this.reset ();
         out = $rh.createReply();
         break;
       ...
       case 5:  // ExitGate/ExitGate/vehicle_exited
       {
