...
{
  private static String  _id = "IDL:CarPark/ExitGateClient:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (CarPark.ExitGateHelper.id (), "ExitGateClient");
    }
    return __typeCode;
  }
