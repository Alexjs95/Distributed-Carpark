...
public class _PayStationStub extends org.omg.CORBA.portable.ObjectImpl implements CarPark.PayStation
{
  ...
  public String pay (String registration, CarPark.Date datePaid, CarPark.Time timePaid, short duration, String operation)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return pay (registration, datePaid, timePaid, duration, operation        );
            } finally {
                _releaseReply ($in);
            }
  } // pay
