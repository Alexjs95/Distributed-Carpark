...
public class _PayStationStub extends org.omg.CORBA.portable.ObjectImpl implements CarPark.PayStation
{
  ...
  public boolean pay (String registration, CarPark.Date datePaid, CarPark.Time timePaid, short duration, double cost, String operation)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return pay (registration, datePaid, timePaid, duration, cost, operation        );
            } finally {
                _releaseReply ($in);
            }
  } // pay
