...
/**
* LocalServer/_LocalServerStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from server.idl
* Thursday, 7 March 2019 11:50:59 o'clock GMT
*/

public class _LocalServerStub extends org.omg.CORBA.portable.ObjectImpl implements LocalServer.LocalServer
{
  ...
  public LocalServer.VehicleEvent[] log ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_log", true);
                $in = _invoke ($out);
                LocalServer.VehicleEvent $result[] = LocalServer.Log_of_vehicle_eventsHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public void vehicle_in (LocalServer.VehicleEvent event)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("vehicle_in", true);
                LocalServer.VehicleEventHelper.write ($out, event);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public void vehicle_out (LocalServer.VehicleEvent event)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public LocalServer.VehicleEvent[] return_log ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
